...
const Player = () => {
  ...
  return (
    <footer className="h-24 bg-black border-t border-gray-800 px-4 flex items-center justify-between">
        ...
        {currentTrack ? (
          <>
            ...
            <button 
              ...
              className={`${trackLiked ? 'text-green-500' : 'text-gray-400'} hover:text-white transition`}
            >
              <svg className="w-5 h-5" fill={trackLiked ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex flex-col items-center gap-2 w-[40%] max-w-[722px]">
        <div className="flex items-center gap-4">
          <button
            ...
            className={`p-2 ${isShuffle ? 'text-green-500' : 'text-gray-400'} hover:text-white transition`}
            title="Shuffle"
          >
          ...
          <button
            ...
            className={`p-2 ${isRepeat ? 'text-green-500' : 'text-gray-400'} hover:text-white transition`}
            title="Repeat"
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 16 16">
